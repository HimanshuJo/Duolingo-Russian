...
def create_word_document(input_path, output_path):
    ...
    table.cell(0, 0).text = 'Russian'
    table.cell(0, 1).text = 'Russian'
...
def main():
    input_folder = r"C:\CustomProjs\Duolingo-Russian\Unit1_Learn_The_Alphabet_Use_Basic_Phrases"
    output_folder = r"C:\CustomProjs\Duolingo-Russian\Unit1_Learn_The_Alphabet_Use_Basic_Phrases"
