...
def main():
    input_folder = r"C:\CustomProjs\Duolingo-Russian\Unit3_Greet_People_Identify_Common_Objects"
    output_folder = r"C:\CustomProjs\Duolingo-Russian\Unit3_Greet_People_Identify_Common_Objects"
